...
@interface IMViewController : PublicViewController{
    //连接对象
    CURL *_curl;
...
@property (weak, nonatomic) IBOutlet UIView *guideView;  //定责View
@property (weak, nonatomic) IBOutlet UIView *guideBacView;
